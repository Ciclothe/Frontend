      ...
      <div className="flex flex-col justify-between min-h-screen">
        ...
        >
          <button
            ...
            } p-2 flex items-center justify-center rounded-full aspect-square ml-4 mb-4 w-8 h-8`}
          ...
          <div className="flex col-span-12 items-center justify-between mx-4">
            <div className="flex gap-4">
              <div
                ...
                onMouseLeave={() =>
                  setLiked(postData?.postAnalitics?.postLiked)
                }
              >
                <HeartIcon
                  size={"1.5em"}
          ...
          {postData?.type !== "Swap" ? (
            ...
            <>
              ...
              <div
                className={`${
                  isNightMode
                    ? "bg-[#0b0b0b] text-black"
                    : "bg-[#F0EFF4] text-white"
