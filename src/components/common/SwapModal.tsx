...
const SwapModal: React.FC<SwapModalProps> = ({ selectedPost, onClose }) => {
  const testPosts = [
    {
  ...
  return (
    <Box
      className={`w-fit  modal rounded-xl ${
        ...
        <div>
          ...
          <div className="px-[1em] py-[1em] md:px-[3em] md:py-[3em] w-[95vw] sm:w-[90vw] md:w-[80vw] lg:w-[60vw] xl:w-[40vw]">
              ...
              <div className="px-5 py-4 grid grid-cols-12">
                <div className="flex items-center col-span-5 sm:col-span-4">
                  ...
                  <p className="font-bold text-[#1B6B44] sm:ml-3">
                    @{selectedPost?.createdBy.userName}
                  </p>
                </div>
                ...
                <div className="relative col-span-5 sm:col-span-4">
                  ...
                  {showPosts && (
                    <ClickAwayListener onClickAway={() => setShowPosts(false)}>
                      <div
                        className={`dropdown  ${
              ...
              <div className="px-5 py-4 grid grid-cols-12 gap-5">
                <div className="col-span-6 sm:col-span-4">
                  {selectedPost?.image[0] && (
                    <img
                      src={selectedPost.image[0].base64}
            ...
            <p className="text-xs font-thin mt-4">
              <span className="opacity-70">{t(`Swap.SwapParagraphOne`)}</span>
              <span className="font-bold opacity-100">
                {t(`Swap.SwapParagraphTwo`)}
              </span>
              <span className="opacity-70">{t(`Swap.SwapParagraphThree`)}</span>
            </p>
            <div className="pt-3 flex items-center justify-center">
              <button type="button" className="btn-grn-fill">
                <p>{t(`Swap.SendOffer`)}</p>
              </button>
            </div>
            <div className="pt-3 flex items-center justify-center">
              <button
